...
document.querySelector('.b-2').addEventListener('click', () => {t1.call(document.querySelector('.out-2'))});
...
res10 = ar9.some((elem) => (typeof(elem) ==  'boolean'));
...
t11 = t1.bind(document.querySelector('.out-11'));
t11();
...
t12 = max.bind(document.querySelector('.out-12'), 11, 88);
t12();
// Task 13
...
t13 = max.bind(document.querySelector('.out-13'), 50);
t13(48);
// Task 14
...
t14 = t9.bind(document.querySelector('.out-14'));
t14.apply(null, ar9);
